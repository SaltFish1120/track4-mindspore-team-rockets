...
DECLARE_OP_ADAPTER(AccumulateNV2)//将AccumulateNV2的类型与标准进行对比，后进行空间调整，并用指针input_map_为key存储相应内容
DECLARE_OP_USE_DYN_INPUT(AccumulateNV2)//将AccumulateNV2的类型与标准进行对比，后进行空间调整，并用指针dyn_input_map_为key存储相应内容
DECLARE_OP_USE_OUTPUT(AccumulateNV2)//将AccumulateNV2的类型与标准进行对比，后进行空间调整，并用指针output_map_为key存储相应内容
