...
//判断replacement_是否为真，若是则返回dataset_size或no_of_samples_
...
Status ShardShuffle::ShuffleFiles(ShardTaskList &tasks) {
  //判断no_of_samples_是否为0，若是则赋值tasks的大小
  if (no_of_samples_ == 0) {
