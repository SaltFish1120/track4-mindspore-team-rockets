...
//定义int型常量KInt1，KInt2，KInt3，kUnsignedInt4
const int kInt0 = 0;
const int kInt1 = 1;
const int kInt2 = 2;
const int kInt3 = 3;
...
const std::vector<std::string> kSupportedVersion = {"2.0", kVersion}; //将2.0，kVersion赋给vector<std::string> kSupportedVersion
...
// translate type in schema to type in sqlite3(NULL, INTEGER, REAL, TEXT, BLOB) 将模式中的类型转换为sqlite3中的类型（NULL、INTEGER、REAL、TEXT、BLOB）
